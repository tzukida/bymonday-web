...
<div class="container-fluid" style="background: linear-gradient(135deg, #f5f0eb 0%, #e8ddd4 100%); min-height: 100vh; padding-bottom: 3rem;">
  <div class="row mb-4">
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h3 class="h3 mb-0" style="color: #4a301f;"><?php echo $user_role; ?> Dashboard</h3>
        ...
        <div class="card-body">
          <?php if (empty($top_items)): ?>
            <div class="text-center py-4 text-muted">
              ...
              <a href="pos.php" class="btn btn-brown btn-sm">
            ...
            <table class="table table-hover align-middle mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-end">
                    <span class="fw-bold text-brown">₱<?php echo number_format($sale['total_amount'], 2); ?></span>
                  </td>
  ...
  <div class="row g-4 mt-2">
    ...
    <div class="col-lg-6">
      <div class="card h-100 border-warning">
        <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #7d5633, #654529); color: white;">
          <h5 class="mb-0">
            <i class="fas fa-exclamation-triangle me-2"></i>
            Low Stock Alert
          </h5>
          <span class="badge bg-white text-brown">
        ...
        <div class="card-footer bg-white border-top">
          <div class="d-flex justify-content-between align-items-center">
            <a href="<?php echo getBaseURL(); ?>/inventory.php?filter=low_stock"
               class="text-decoration-none text-brown fw-semibold">
      ...
      <div class="card h-100">
        ...
        <div class="card-body p-0">
          ...
          <div class="text-center py-5">
            ...
            <a href="<?php echo getBaseURL(); ?>/inventory.php" class="btn btn-brown btn-sm">
          ...
          datasets: [
            {
              ...
              backgroundColor: 'rgba(56, 36, 23, 0.7)',
              borderWidth: 0,
              borderRadius: 6,
              yAxisID: 'y'
            },
            {
              ...
              type: 'line',
              borderColor: 'rgba(77, 52, 32, 1)',
              backgroundColor: 'rgba(77, 52, 32, 0.1)',
              borderWidth: 3,
              tension: 0.4,
              fill: true,
              yAxisID: 'y1',
              pointRadius: 5,
              pointBackgroundColor: 'rgba(77, 52, 32, 1)',
...
.bg-brown { background-color: #382417; color: #fff; }
.text-brown { color: #382417; }
