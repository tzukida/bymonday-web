    ...
    if (!verifyCsrfToken($_POST[CSRF_TOKEN_NAME] ?? '')) {
        ...
        if (empty($errors)) {
            ...
            if ($stmt->execute()) {
                ...
                redirect('superadmin/inventory.php?success=item_updated');
            } else {
                $stmt->close();
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="quantity" class="form-label">
                    <i class="fas fa-hashtag me-1"></i>Current Quantity <span class="text-brown">*</span>
                  </label>
                  <input type="number"
                         class="form-control"
                         id="quantity"
        ...
        <div class="card-body">
          <div class="mb-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
              ...
              <span class="fw-bold fs-5 text-brown">
          ...
          <div class="d-grid gap-2">
            <a href="stock_in.php?item_id=<?php echo $item_id; ?>" class="btn btn-sm btn-brown">
              <i class="fas fa-plus me-2"></i>Add Stock (Stock In)
            </a>
            <a href="stock_out.php?item_id=<?php echo $item_id; ?>" class="btn btn-sm btn-outline-brown">
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
                ...
                <div class="d-flex justify-content-between align-items-start">
                  <div>
                    <?php if ($trans['type'] === 'stock-in'): ?>
                      <span class="badge bg-brown mb-1">
          ...
          <div class="card-footer bg-white border-top">
            <a href="transactions.php" class="text-decoration-none text-brown small">
