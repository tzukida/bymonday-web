  ...
  <div class="row mb-4">
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h3 class="h3 mb-0" style="color: #4a301f;">Database Backup</h3>
  ...
  <div class="row g-4">
    ...
    <div class="col-lg-8">
      <div class="card h-100 border-brown">
        <div class="card-header text-white" style="background: linear-gradient(135deg, #4d3420 0%, #382417 100%);">
          <h5 class="mb-0">
        ...
        <div class="card-body d-flex flex-column">
          <div class="row flex-grow-1">
            <div class="col-md-7 d-flex flex-column">
              <div class="alert alert-brown mb-4 htable">
              ...
              <div class="backup-tables-list flex-grow-1">
                ...
                <div class="d-flex justify-content-between align-items-center p-2 bg-light rounded mb-2">
                  <span class="text-capitalize small">
                    <i class="fas fa-table text-brown me-2" style="font-size: 0.75rem;"></i>
        ...
        <div class="card-body">
          <div class="mb-3">
            <div class="d-flex mb-3">
              <div class="me-3">
                <div class="bg-brown bg-opacity-10 rounded p-2">
                  <i class="fas fa-check-circle text-brown fa-lg"></i>
                </div>
              </div>
              <div>
            ...
            <div class="d-flex mb-3">
              <div class="me-3">
                <div class="bg-brown bg-opacity-10 rounded p-2">
                  <i class="fas fa-shield-alt text-brown fa-lg"></i>
                </div>
              </div>
              <div>
            ...
            <div class="d-flex mb-3">
              <div class="me-3">
                <div class="bg-brown bg-opacity-10 rounded p-2">
                  <i class="fas fa-vial text-brown fa-lg"></i>
                </div>
              </div>
              <div>
            ...
            <div class="d-flex">
              <div class="me-3">
                <div class="bg-brown bg-opacity-10 rounded p-2">
                  <i class="fas fa-copy text-brown fa-lg"></i>
                </div>
              </div>
              <div>
              ...
              <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <i class="fas fa-file-archive text-brown me-2"></i>
...
.border-brown {
  border: 2px solid #654529 !important;
}
...
.bg-brown.bg-opacity-10 {
  background-color: rgba(56, 36, 23, 0.1) !important;
}
