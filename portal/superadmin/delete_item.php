  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($confirm !== 'DELETE') {
        ...
        try {
            ...
            redirect('superadmin/inventory.php?success=item_deleted');
        } catch (Exception $e) {
            $conn->rollback();
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <div class="fw-bold fs-5 text-brown">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="text-center p-3 border rounded">
                <div class="mb-2">
                  <i class="fas fa-utensils fa-2x <?php echo $is_used_in_recipes ? 'text-warning' : 'text-brown'; ?>"></i>
                </div>
            ...
            <div class="col-md-4">
              <div class="text-center p-3 border rounded">
                <div class="mb-2">
                  <i class="fas fa-box fa-2x text-brown"></i>
                </div>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          <ul class="list-unstyled mb-0">
            <li class="mb-2">
              <i class="fas fa-arrow-right text-brown me-2"></i>
              <a href="edit_item.php?id=<?php echo $item_id; ?>" class="text-brown">Edit the item</a> if you want to update its information
            </li>
            <li class="mb-2">
              <i class="fas fa-arrow-right text-brown me-2"></i>
              <a href="stock_out.php?item_id=<?php echo $item_id; ?>" class="text-brown">Record a stock-out</a> to reduce quantity to zero
            </li>
            <li class="mb-0">
