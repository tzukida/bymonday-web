  ...
  <div class="row mb-4">
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h3 class="h3 mb-0" style="color: #4a301f;">Menu Management</h3>
          <p class="text-muted mb-0">Manage menu items and their recipes</p>
        </div>
        <div class="d-flex gap-2">
          <a href="pos.php" class="btn btn-outline-brown">
          ...
          <?php if (empty($menu_items)): ?>
            <div class="text-center py-5">
              ...
              <?php if (!empty($search) || $category_filter !== 'all' || $status_filter !== 'all'): ?>
                ...
                <a href="menu_management.php" class="btn btn-outline-brown">Clear Filters</a>
              <?php else: ?>
