...
<div class="container-fluid">
  <div class="row mb-4">
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
          <a href="<?php echo getBaseURL() . $inventory_page; ?>" class="btn btn-brown">
  ...
  <div class="row">
    <div class="col-lg-8">
      <div class="card mb-4" style="border: 2px solid #3b2008;">
      ...
      <div class="card">
        <div class="card-header bg-white py-3">
          <h5 class="mb-0">
            <i class="fas fa-clipboard-list me-2 icon-brown"></i>Record Stock Out
          </h5>
        </div>
        <div class="card-body">
          <form method="POST" id="stockOutForm" novalidate>
              ...
              <div class="col-md-6">
                <div class="mb-4">
                  <label for="quantity" class="form-label fw-semibold">
                    <i class="fas fa-minus-circle icon-brown me-1"></i>
              ...
              <div class="col-md-6">
                <div class="mb-4">
                  ...
                  <div class="border rounded p-3 bg-light">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                      <span class="icon-brown">- Removing:</span>
                      <span class="fw-bold icon-brown" id="removing-display">0.00 <?php echo htmlspecialchars($item['unit']); ?></span>
                    </div>
                    <hr class="my-2">
                    <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="mb-4">
              ...
              <div class="d-flex gap-2 flex-wrap">
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Used in production">Used in production</button>
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Spoilage/Expired">Spoilage/Expired</button>
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Damaged during storage">Damaged during storage</button>
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Quality control rejection">Quality control rejection</button>
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Waste/Spillage">Waste/Spillage</button>
                <button type="button" class="btn btn-sm btn-outline-secondary quick-remark" data-remark="Sample/Testing">Sample/Testing</button>
              </div>
            </div>

            <div class="alert-brown-light mb-4">
            ...
            <div class="d-flex gap-3">
              <button type="submit" class="btn btn-brown btn-lg flex-grow-1" id="submitBtn">
                <i class="fas fa-check me-2"></i>Confirm Stock Out
              </button>
              <a href="<?php echo getBaseURL() . $inventory_page; ?>" class="btn btn-outline-secondary btn-lg flex-grow-1">
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        <div class="card-header bg-white py-3">
          <h6 class="mb-0">
            <i class="fas fa-history me-2 icon-brown"></i>Recent Stock Outs
          </h6>
        </div>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          <ul class="list-unstyled mb-0 small">
            <li class="mb-2"><i class="fas fa-check-circle icon-brown me-2"></i>Always provide a clear reason for removal</li>
            <li class="mb-2"><i class="fas fa-check-circle icon-brown me-2"></i>Double-check quantities before confirming</li>
            <li class="mb-2"><i class="fas fa-check-circle icon-brown me-2"></i>Document waste or spoilage for auditing</li>
            <li class="mb-0"><i class="fas fa-check-circle icon-brown me-2"></i>Monitor low stock items regularly</li>
          </ul>
        </div>
      </div>
    </div>
...
.border-brown { border-color: #3b2008 !important; }
...
#removing-display, #remaining-total { transition: all 0.3s ease; }
...
.alert.alert-success {
  ...
  --bs-alert-bg: #f5ede6 !important;
  --bs-alert-border-color: #3b2008 !important;
  --bs-alert-color: #3b2008 !important;
}
...
/* All button states locked to brown */
.btn-brown {
  background-color: #3b2008;
  border-color: #3b2008;
  color: #fff;
...
@media (max-width: 768px) {
  .input-group-lg .form-control { font-size: 1.2rem; }
}
</style>
...
$(document).ready(function() {
  ...
  quantityInput.on('input', function() {
    ...
    if (remaining < 10) {
      ...
      remainingTotal.css('color', '#fd7e14');
  ...
  $('.quick-remark').on('click', function() {
    ...
    remarksInput.val(currentRemarks === '' ? remark : currentRemarks + ', ' + remark);
