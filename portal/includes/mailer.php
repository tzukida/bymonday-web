...
function sendRestockEmail($to, array $items) {
    ...
    foreach ($items as $item) {
        ...
        <tr>
            ...
            <td style='border:1px solid #dee2e6;padding:10px 14px;color:#dc3545;font-weight:700;'>{$item['quantity']} {$item['unit']}</td>
            <td style='border:1px solid #dee2e6;padding:10px 14px;color:#198754;font-weight:700;'>{$item['quantity']} {$item['unit']}</td>
            <td style='border:1px solid #dee2e6;padding:10px 14px;color:#6c757d;'>{$threshold} {$item['unit']}</td>
        </tr>";
    }
  ...
  <tr><td style='padding:28px 36px;color:#212529;font-size:15px;line-height:1.7;'>
    ...
    <table width='100%' cellpadding='0' cellspacing='0' style='border-collapse:collapse;margin:20px 0;'>
      <tr style='background:#f8f9fa;'>
        ...
        <th style='border:1px solid #dee2e6;padding:10px 14px;text-align:left;color:#495057;'>Current Stock</th>
        <th style='border:1px solid #dee2e6;padding:10px 14px;text-align:left;color:#495057;'>Qty Requested</th>
        <th style='border:1px solid #dee2e6;padding:10px 14px;text-align:left;color:#495057;'>Threshold</th>
      </tr>
      $html_rows
    </table>
